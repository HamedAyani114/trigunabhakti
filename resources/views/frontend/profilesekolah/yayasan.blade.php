  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 video-box">
        <img style="padding-top:10%; padding-right:5%;padding-left:5%;"
          src="{{ asset('images\pegawai\1681237095-bapakmurdiono.jpeg') }}" height="" class="img-fluid" alt="">
      </div>
    ...
    <div class="row" data-aos="fade-up">
      <div class="col-lg-6">
        <div class="icon-box">
          ...
          <p class="description" style="text-align: justify">Mewujudkan Lembaga Pendidikan yang Unggul dalam Melayani
            Umat di Bidang Sosial, Pendidikan dan Keagamaan untuk Membangun Sumber Daya Manusia (SDM) yang Berkarakter,
            Cerdas, Integritas dan Berakhlaq Mulia.</p>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="icon-box">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
          ...
          <div>
            ...
            <p class="description">Untuk menjadikan siswa siswi lebih bertaqwa kepada Tuhan YME. dengan adanya kelas
              mengaji. Lebih memahami bacaan dan tajwid dalam membaca Al-Qur'an.</p>
          </div>
