<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="/" target="_blank">Tri Guna Bhakti</a>
    </div>
    ...
    <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
      ...
      <ul class="sidebar-menu">
        {{-- <li><a class="nav-link" href="{{ route('todo.index') }}"><i class="fas fa-calendar"></i> <span>To
              Do</span></a></li> --}}
        <li>
        <li class="dropdown">
        ...
        <li><a class="nav-link" href="{{ route('pegawai.index') }}"><i class="fas fa-chalkboard-teacher"></i>
            <span>Manage pegawai</span></a></li>
        <li><a class="nav-link" href="{{ route('user.index') }}"><i class="fas fa-user"></i> <span>Manage
              User</span></a></li>
        {{-- <li><a class="nav-link" href="{{ route('setting.index')}}"><i class="fas fa-cogs"></i>
            <span>Settings</span></a></li> --}}
        @endif
        <li><a class="nav-link" href="{{ route('about.credit')}}"><i class="fas fa-fire"></i> <span>Credits</span></a>
        </li>
      </ul>
  </aside>
</div>