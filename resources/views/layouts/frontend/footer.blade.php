    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 footer-links">
        ...
        <ul>
          ...
          <li><i class="bx bx-chevron-right"></i> <a href="{{ route('sd') }}">SD Tri Guna Bhakti</a></li>
          <li><i class="bx bx-chevron-right"></i> <a href="{{ route('smp') }}">SMP Tri Guna Bhakti</a></li>
          <li><i class="bx bx-chevron-right"></i> <a href="{{ route('smk') }}">SMK Tri Guna Bhakti</a></li>
        </ul>
      </div>
      ...
      <div class="col-lg-3 col-md-6 footer-contact">
        ...
        <p>
          ...
          <strong><a style="padding-right:10px;" href="https://instagram.com/trigunabhakti.ofc?igshid=YmMyMTA2M2Y="> <i style="font-size:22px;" class="fa-brands fa-instagram"></i></a></strong> 
          <strong><a style="padding-right:10px;" href="#"> <i style="font-size:22px;" class="fa-brands fa-twitter"></i></a></strong>  
          <strong><a style="padding-right:10px;" href="https://www.facebook.com/profile.php?id=100089912815887"> <i style="font-size:22px;" class="fa-brands fa-facebook"></i></a></strong>          </p>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('sd') }}">SD TRI GUNA BHAKTI</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('smp') }}">SMP TRI GUNA BHAKTI</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('smk') }}">SMA TRI GUNA BHAKTI</a></li>
          </ul>
        </div>
